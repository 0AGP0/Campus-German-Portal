...
export const FIELD_LABEL_TR: Record<string, string> = {
  ...
  fullName: "Ad soyad (tam)",
  birthDate: "Doğum tarihi",
  demoLessonRequested: "Demo ders talebi",
  quoteSubmitIntent: "Gönderim / niyet",
  startDateMode: "Başlangıç tarihi modu",
  startDateIso: "Başlangıç tarihi (ISO)",
  startDateLabel: "Başlangıç tarihi (metin)",
  first_name: "Ad",
  last_name: "Soyad",
...
const KANBAN_CARD_SECTIONS: Record<LeadFormType, { title: string; keys: readonly string[] }[]> = {
  ...
  quote: [
    { title: "Program", keys: ["program", "courseTitle", "level", "courseSelection"] },
    { title: "İletişim", keys: ["email"] },
    { title: "Kayıt", keys: ["formDate"] },
  ],
  "private-documents-form": [
...
export const DETAIL_FORM_CATEGORIES: Record<LeadFormType, readonly DetailFormCategory[]> = {
  ...
  quote: [
    {
      id: "kisi",
      title: "Kişi ve iletişim",
      keys: ["firstName", "lastName", "fullName", "phone", "email", "birthDate", "nationality"],
    },
    {
      id: "program",
    ...
    {
      id: "kaynak",
      title: "Form ve kaynak",
      keys: ["formDate", "sourcePage", "siteLanguage"],
    },
  ],
  "private-documents-form": [
